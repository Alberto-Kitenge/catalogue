...
class AdminController extends Controller
{
    ...
    {
        return $this->savePost($request->validated(), new Post());
    }
    ...
    {
        return $this->savePost($request->validated(), $post);
    }

    protected function savePost(array $data, Post $post): RedirectResponse
    {
        ...
        return redirect()
                ...
                ->with('success', $post->wasRecentlyCreated ? 'Post publié !' : 'Post modifié !');
    }
